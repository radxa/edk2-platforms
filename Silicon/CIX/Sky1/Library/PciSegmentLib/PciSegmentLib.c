...
#define PCIE_ECAM_BASE_ADDRESS  0x20000000
  ...
  )
{
  ...
  MmioAddress = PCIE_ECAM_BASE_ADDRESS + (UINT32)Address;

  switch (Width) {
    case PciCfgWidthUint8:
      return MmioRead8 (MmioAddress);
    case PciCfgWidthUint16:
      return MmioRead16 (MmioAddress);
    case PciCfgWidthUint32:
      return MmioRead32 (MmioAddress);
    default:
      ASSERT (FALSE);
  }
  ...
  )
{
  ...
  switch (Width) {
    case PciCfgWidthUint8:
      MmioWrite8 (MmioAddress, Data);
      break;
    case PciCfgWidthUint16:
      MmioWrite16 (MmioAddress, Data);
      break;
    case PciCfgWidthUint32:
      MmioWrite32 (MmioAddress, Data);
      break;
    default:
      ASSERT (FALSE);
  }
