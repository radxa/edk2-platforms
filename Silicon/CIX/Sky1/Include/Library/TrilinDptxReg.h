...
// ------------------------------------------------------------------------------
#define TRILIN_DPTX_SRC2_EDP_CRC_ENABLE  0xd90ul
#define TRILIN_DPTX_SRC2_EDP_CRC_RED     0xd94ul
#define TRILIN_DPTX_SRC2_EDP_CRC_GREEN   0xd98ul
#define TRILIN_DPTX_SRC2_EDP_CRC_BLUE    0xd9cul

// ------------------------------------------------------------------------------
//   PSR/PSR2
// ------------------------------------------------------------------------------
#define TRILIN_DPTX_SRC2_PSR_3D_ENABLE       0xda0ul
#define TRILIN_DPTX_SRC2_PSR_CONFIG          0xda4ul
#define TRILIN_DPTX_SRC2_PSR_STATE           0xda8ul
#define TRILIN_DPTX_SRC2_PSR_INTERNAL_STATE  0xdacul
#define TRILIN_DPTX_SRC2_PSR2_UPDATE_TOP     0xdb0ul
#define TRILIN_DPTX_SRC2_PSR2_UPDATE_BOTTOM  0xdb4ul
#define TRILIN_DPTX_SRC2_PSR2_UPDATE_LEFT    0xdb8ul
#define TRILIN_DPTX_SRC2_PSR2_UPDATE_WIDTH   0xdbcul
...
// ------------------------------------------------------------------------------
#define TRILIN_DPTX_SRC3_EDP_CRC_ENABLE  0xf90ul
#define TRILIN_DPTX_SRC3_EDP_CRC_RED     0xf94ul
#define TRILIN_DPTX_SRC3_EDP_CRC_GREEN   0xf98ul
#define TRILIN_DPTX_SRC3_EDP_CRC_BLUE    0xf9cul

// ------------------------------------------------------------------------------
//   PSR/PSR2
// ------------------------------------------------------------------------------
#define TRILIN_DPTX_SRC3_PSR_3D_ENABLE       0xfa0ul
#define TRILIN_DPTX_SRC3_PSR_CONFIG          0xfa4ul
#define TRILIN_DPTX_SRC3_PSR_STATE           0xfa8ul
#define TRILIN_DPTX_SRC3_PSR_INTERNAL_STATE  0xfacul
#define TRILIN_DPTX_SRC3_PSR2_UPDATE_TOP     0xfb0ul
#define TRILIN_DPTX_SRC3_PSR2_UPDATE_BOTTOM  0xfb4ul
#define TRILIN_DPTX_SRC3_PSR2_UPDATE_LEFT    0xfb8ul
#define TRILIN_DPTX_SRC3_PSR2_UPDATE_WIDTH   0xfbcul
