...
/* Scaler registers */
#define SC_INPUT_ID0   0x080
#define SC_CONTROL     0x0D0
#define SC_COEFFTAB    0x0DC
#define SC_IN_SIZE     0x0E0
...
#define SC_ENH_COEFF1  0x138
#define SC_ENH_COEFF2  0x13c
#define SC_ENH_COEFF3  0x140
#define SC_ENH_COEFF4  0x144
#define SC_ENH_COEFF5  0x148
#define SC_ENH_COEFF6  0x14c
#define SC_ENH_COEFF7  0x150
#define SC_ENH_COEFF8  0x154
...
#define DP_LPU0_BASE             0x0200
#define DP_LPU0_LAYER0_BASE      0x0400
#define DP_LPU0_LAYER2_BASE      0x0800
#define DP_CU0_BASE              0x0E00
#define DP_CU0_SCALER0_BASE      0x1200
#define DP_CU0_SCALER1_BASE      0x1400
#define DP_CU0_LINE_MERGER_BASE  0x1600
#define DP_DOU0_BS_BASE          0x1E00
#define DP_DOU0_IPS_BASE         0x1A00

struct block_header {
  UINT32    block_info;
  UINT32    pipeline_info;
  UINT32    input_ids[D71_BLOCK_MAX_INPUT];
  UINT32    output_ids[D71_BLOCK_MAX_OUTPUT];
};
