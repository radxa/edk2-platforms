...
#ifndef __CLOCK_ID_H__
#define __CLOCK_ID_H__
...
typedef
  EFI_STATUS
(EFIAPI *CLOCK_DISABLE)(
  IN  UINT32    ClockId
  );

typedef
  EFI_STATUS
(EFIAPI *CLOCK_RATE_SET)(
  IN  UINT32    ClockId,
  IN  UINT64    Rate
  );
...
#define CLK_TREE_DSU_PLL               267
#define CLK_TREE_NPU_DIV               268
