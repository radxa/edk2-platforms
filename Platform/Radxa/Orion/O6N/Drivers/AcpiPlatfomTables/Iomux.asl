...
// Platform defined pinctrl
    ...
    PinGroup ("pinctrl_fch_uart3_gpio", ResourceProducer, ,
        RawDataBuffer ()
        {
            IO_S0_UART3_TXD, 0x00, 0xA7,
            IO_S0_UART3_RXD, 0x00, 0xA7,
        })
        {
            SKY1_IOMUXC_UART3_TXD,
            SKY1_IOMUXC_UART3_RXD,
        }
...
// Device defined pinctrl
    ...
    PinGroup ("gpio001_mkey_en", ResourceProducer, ,
        RawDataBuffer ()
        {
            IO_S5_GPIO001, 0x00, 0x44,
        })
        {
            SKY1_IOMUXC_GPIO1,
        }
