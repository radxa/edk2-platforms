...
#define VOL_Major_VER_V0          0x0     //v0.0 develop only
#define VOL_Major_VER_V1          0x1     //v1.0 develop only
#define VOL_Major_VER_V2          0x2     //v2.0 develop only
#define VOL_Major_VER_V3          0x3     //v3.0 develop only
#define VOL_Major_VER_V4          0x4     //v4.0 develop only
#define VOL_Major_VER_V15         0xf     //v15.0 for mass-product only
