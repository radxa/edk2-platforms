...
GPIO_CFG  GpioCfgTable[] = {
  ...
  { 8,   OUTPUT,            INOUT_HIGH,          INTERRUPT_TYPE_DEFAULT,   INTERRUPT_TYPE_DEFAULT }, // GPIO8(DEFAULT HIGH, LED OFF)
  ...
  { 15,  OUTPUT,            INOUT_LOW,           INTERRUPT_ENABLE_DEFAULT, INTERRUPT_TYPE_DEFAULT }, // PWR_LED_EN GPIO15 (DEFAULT LOW, LED ON)
  ...
  { 105, OUTPUT,            INOUT_LOW,           INTERRUPT_ENABLE_DEFAULT, INTERRUPT_TYPE_DEFAULT }, // GPIO105 (DEFAULT LOW)
  { 106, OUTPUT,            INOUT_LOW,           INTERRUPT_ENABLE_DEFAULT, INTERRUPT_TYPE_DEFAULT }, // GPIO106 (DEFAULT LOW)
...
PINMUX_CFG  PinMuxCfgTable[] = {
  ...
  { S0_DOMAIN,       IO_S0_UART3_TXD,        IO_FUNC01,   PU_ENABLE,  PD_DISABLE, ST_DEFAULT, DRV_STREN_DEFAULT }, // GPIO105
  { S0_DOMAIN,       IO_S0_UART3_RXD,        IO_FUNC01,   PU_ENABLE,  PD_DISABLE, ST_DEFAULT, DRV_STREN_DEFAULT }, // GPIO106
  // NON_GMAC1
