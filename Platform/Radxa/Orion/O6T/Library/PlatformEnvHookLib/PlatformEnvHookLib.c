...
GPIO_CFG  GpioCfgTable[] = {
  ...
  { 7,   OUTPUT,            INOUT_HIGH,          INTERRUPT_ENABLE_DEFAULT, INTERRUPT_TYPE_DEFAULT }, // PD_RESET
  ...
  { 16,  OUTPUT,            INOUT_LOW,           INTERRUPT_ENABLE_DEFAULT, INTERRUPT_TYPE_DEFAULT }, // PWRBTN_L
  ...
  { 70,  OUTPUT,            INOUT_LOW,           INTERRUPT_ENABLE_DEFAULT, INTERRUPT_TYPE_DEFAULT }, // OCULINK_PWREN
...
PINMUX_CFG  PinMuxCfgTable[] = {
  { S0_DOMAIN,       IO_S0_I2S2_MCLK,        IO_FUNC01,   PU_ENABLE,  PD_DEFAULT, ST_DEFAULT, DRV_STREN_3       }, // OCULINK_PWREN
  ...
  { S5_DOMAIN,       IO_S5_SFI_GPIO1,        IO_FUNC02,   PU_DEFAULT, PD_DEFAULT, ST_DEFAULT, DRV_STREN_DEFAULT }, // PWRBTN_L
  ...
  )
{
  ...
  if (ConfigData->PlatConfig->GfxPower == 0) {
    // GPIO070
    DEBUG ((DEBUG_INFO, "GPIO070 Output Low GFX Power Off\n"));
    GpioConfig (70, OUTPUT, INOUT_LOW, INTERRUPT_DISABLE, INTERRUPT_TYPE_DEFAULT);
  } else {
    // GPIO070
    DEBUG ((DEBUG_INFO, "GPIO070 Output Low GFX Power On\n"));
    GpioConfig (70, OUTPUT, INOUT_HIGH, INTERRUPT_DISABLE, INTERRUPT_TYPE_DEFAULT);
  }
