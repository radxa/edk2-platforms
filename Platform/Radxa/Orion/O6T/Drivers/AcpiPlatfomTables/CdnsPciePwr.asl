...
External (\_SB.PRC4, DeviceObj)
  ...
  Device (PVC0) {
    ...
    Name (_CRS, ResourceTemplate () {
      PinGroupFunction(Exclusive, 0x0, "\\_SB.MUX0", 0, "oculink_pwren", ResourceConsumer,)
      GpioIo (Exclusive, PullNone, 0, 0, IoRestrictionOutputOnly,
      "\\_SB.GPI0", 0, ResourceConsumer) { 27 }  // GPIO070
    })
    ...
    Name (_DSD, Package () {
      ...
      Package () {
        ...
        Package () { "gpio", Package () { ^PVC0, 0, 0, GPIO_ACTIVE_LOW } },
