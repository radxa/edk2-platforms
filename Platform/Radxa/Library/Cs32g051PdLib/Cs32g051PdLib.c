...
#define DATA_STATUS_REG 		    0x5F
#define RETIMER_DEBUG_MODE_REG  0x5D
#define DATA_CONTROL_REG		    0x50
#define PD_CONTROL_STATE_REG	  0x03
#define SOC_ALERT_SIGNAL        0x88
  ...
  )
{
  ...
  UINT8  wdata[4] = { DATA_CONTROL_REG, 2, BIT2, 0 };
