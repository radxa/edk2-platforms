...
EFI_STATUS WriteGpt (UINT8 *ImageBuffer, UINT32 Size);
...
EFI_STATUS ReadFromPartitionByName (IN CHAR16 *PartitionName, IN INT64 Offset, IN UINT64 Size, IN VOID *Image);
EFI_STATUS WriteToPartition (EFI_BLOCK_IO_PROTOCOL *BlockIo, IN EFI_HANDLE *Handle,
                                  IN INT64 Offset, IN UINT64 Size, IN VOID *Image);
EFI_STATUS WriteToPartitionByName (IN CHAR16 *PartitionName, IN INT64 Offset, IN UINT64 Size, IN VOID *Image);
