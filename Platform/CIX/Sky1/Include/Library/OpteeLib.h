...
EFI_STATUS
EFIAPI
OpteeUpdateNsRuntimeBufferInfo (
  IN UINTN  Base,
  IN UINTN  Size
  );
...
EFI_STATUS
EFIAPI
OpteeGetFwOpteeCommunicateBufferInfo (
  OUT UINTN  *Base,
  OUT UINTN  *Size
  );
...
EFI_STATUS
EFIAPI
OpteeUpdateFwOpteeCommunicateNsRuntimeBufferInfo (
  IN UINTN  Base,
  IN UINTN  Size
  );
...
EFI_STATUS
EFIAPI
OpteeUpdateFwNsRuntimeBufferInfo (
  IN UINTN  Base,
  IN UINTN  Size
  );
