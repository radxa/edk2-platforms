...
#define PROCESSOR_NO_WAIT_BIT  0x00000008
...
typedef
EFI_STATUS
(EFIAPI *WAIT_AP_PROCEDURE_ALL_COMPLETED)(
  IN UINTN WaitCoreBitMap
  );

typedef
EFI_STATUS
(EFIAPI *WAIT_THIS_AP_PROCEDURE_COMPLETED)(
  IN UINTN TimeOut,
  IN UINTN  ProcessorNumber
  );
...
struct _EFI_MP_SERVICES_PROTOCOL {
  ...
  WAIT_AP_PROCEDURE_ALL_COMPLETED             WaitAllApCompleted;
  WAIT_THIS_AP_PROCEDURE_COMPLETED            WaitThisApCompleted;
};
