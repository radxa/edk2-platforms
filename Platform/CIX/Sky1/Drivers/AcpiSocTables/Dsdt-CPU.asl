...
Device (CPU0)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_0_TO_3_DESIRED_PERF_REG, 0, 1, CORE_0_TO_3_HIGHEST_PERF, CORE_0_TO_3_NOMINAL_PERF, CORE_0_TO_3_LOWEST_NON_LINEAR_PERF, CORE_0_TO_3_LOWEST_PERF, CORE_0_TO_3_REF_PERF)
    )
    Name (_PSD, Package () {
...
Device (CPU4)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_4_5_DESIRED_PERF_REG, 0, 1, CORE_4_5_HIGHEST_PERF, CORE_4_5_NOMINAL_PERF, CORE_4_5_LOWEST_NON_LINEAR_PERF, CORE_4_5_LOWEST_PERF, CORE_4_5_REF_PERF)
    )
    Name (_PSD, Package () {
...
Device (CPU6)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_6_7_DESIRED_PERF_REG, 0, 1, CORE_6_7_HIGHEST_PERF, CORE_6_7_NOMINAL_PERF, CORE_6_7_LOWEST_NON_LINEAR_PERF, CORE_6_7_LOWEST_PERF, CORE_6_7_REF_PERF)
    )
    Name (_PSD, Package () {
...
Device (CPU8)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_8_9_DESIRED_PERF_REG, 0, 1, CORE_8_9_HIGHEST_PERF, CORE_8_9_NOMINAL_PERF, CORE_8_9_LOWEST_NON_LINEAR_PERF, CORE_8_9_LOWEST_PERF, CORE_8_9_REF_PERF)
    )
    Name (_PSD, Package () {
...
Device (CP10)
{
    ...
    Name (_CPC, Package()
      CPPC_PACKAGE_INIT (CORE_10_11_DESIRED_PERF_REG, 0, 1, CORE_10_11_HIGHEST_PERF, CORE_10_11_NOMINAL_PERF, CORE_10_11_LOWEST_NON_LINEAR_PERF, CORE_10_11_LOWEST_PERF, CORE_10_11_REF_PERF)
    )
    Name (_PSD, Package () {
