...
External (\_SB.CPUL, PkgObj)


#define EC_BATTERY_SUPPORT FixedPcdGetBool(PcdAcpiEcBatterySupport)
#define EC_THERMAL_SUPPORT FixedPcdGetBool(PcdAcpiEcThermalSupport)
#define EC_LID_SUPPORT     FixedPcdGetBool(PcdAcpiEcLidSupport)
#define EC_PWRB_SUPPORT    FixedPcdGetBool(PcdAcpiEcPowerButtonSupport)
